...
class Classifier(nn.Module):
  def __init__(self, d_model=79, n_spks=600, dropout=0.1):
    super().__init__()
    ...
    self.encoder_layer = nn.TransformerEncoderLayer(
            d_model=d_model, dim_feedforward=2050, nhead=1
    )
...
def main(
  ...
  optimizer = AdamW(model.parameters(), lr=0.0035)
