...
if __name__ == "__main__":
	...
	print("rr=%f%%" %(rr*100), "    by action1")
	
	actionMat = myAction02(priceMat, transFeeRate, 600)
	rr = computeReturnRate(priceMat, transFeeRate, actionMat)  # Compute return rate
	print("rr=%f%%" %(rr*100), "    by action2, k=600")
	
	actionMat = myAction02(priceMat, transFeeRate, 800)
	rr = computeReturnRate(priceMat, transFeeRate, actionMat)  # Compute return rate
	print("rr=%f%%" %(rr*100), "    by action2, k=800")
	
	actionMat = myAction02(priceMat, transFeeRate, 1000)
	rr = computeReturnRate(priceMat, transFeeRate, actionMat)  # Compute return rate
	print("rr=%f%%" %(rr*100), "    by action2, k=1000")
	
	actionMat = myAction03(priceMat, transFeeRate, 600)
	rr = computeReturnRate(priceMat, transFeeRate, actionMat)  # Compute return rate
	print("rr=%f%%" %(rr*100), "    by action3, k=600")

	actionMat = myAction03(priceMat, transFeeRate, 800)
	rr = computeReturnRate(priceMat, transFeeRate, actionMat)  # Compute return rate
	print("rr=%f%%" %(rr*100), "    by action3, k=800")

	actionMat = myAction03(priceMat, transFeeRate, 1000)
	rr = computeReturnRate(priceMat, transFeeRate, actionMat)  # Compute return rate
	print("rr=%f%%" %(rr*100), "    by action3, k=1000")